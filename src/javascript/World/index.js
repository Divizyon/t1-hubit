...
export default class World {
    ...
    setResetButton() {
        ...
        if(this.debug) {
            ...
            resetFolder.add(this.resetButton.areaLabelMesh.position, 'x').name('X position').onChange(() => {
                this.resetButton.resetArea.position.x = this.resetButton.areaLabelMesh.position.x
                this.resetButton.resetArea.update()
                this.resetButton.areaLabelMesh.updateMatrix()
            })
            resetFolder.add(this.resetButton.areaLabelMesh.position, 'y').name('Y position').onChange(() => {
                this.resetButton.resetArea.position.y = this.resetButton.areaLabelMesh.position.y
                this.resetButton.resetArea.update()
                this.resetButton.areaLabelMesh.updateMatrix()
            })
        }
