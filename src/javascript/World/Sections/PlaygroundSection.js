...
export default class PlaygroundSection {
  constructor(_options) {
    ...
    // this.setBricksWalls()
    // this.setBowling()
    // GreenBox artık World/index.js içinde setGreenBox metodu ile ekleniyor
  }
  ...
  setStatic() {
    this.objects.add({
      ...
      floorShadowTexture:
        this.resources.items.playgroundStaticFloorShadowTexture,
  ...
  // setGreenBox() method has been removed and moved to index.js
}
