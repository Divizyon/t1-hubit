...
export default class PlaygroundSection
{
    constructor(_options)
    {
        ...
        this.scene = _options.scene // Scene parametresi eklendi
        ...
        // resources.items.greenBoxBase'in var olduğundan emin ol
        if (this.resources.items && this.resources.items.greenBoxBase && this.resources.items.greenBoxBase.scene) {
