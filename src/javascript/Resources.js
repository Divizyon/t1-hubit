...
export default class Resources extends EventEmitter {
  constructor() {
    ...
    this.loader.load([
      ...
      // Animated Models
      {
        name: "boatDockWithSeagull",
        source: "./models/boat_dock_with_seagull_isometric_animated.glb",
        type: "gltfAnimation",
      },
      {
        name: "toyRobotAnimated",
      ...
      // Togg
      {
        ...
        source: "./models/car/cyberTruck/Tog_Shade_Version.glb",
      },
      {
